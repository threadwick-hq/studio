...
![A multi-round granny square chart generated by Threadwick](samples/granny-square.png)
...
**Zero setup:** open [`dist/threadwick.html`](dist/threadwick.html) directly in a
...
- **Save / Open** — a `.threadwick.json` project file (also autosaved locally).

Two sample projects live in [`samples/`](samples/) — open either from the app:
[`basic-granny.threadwick.json`](samples/basic-granny.threadwick.json) (the
starter) and [`granny-square.threadwick.json`](samples/granny-square.threadwick.json)
